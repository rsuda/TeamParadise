...
<title>Team Paradise: Changelog</title>
...
&lt;a href="https://github.com/mongodb/js-bson/compare/v1.1.4...v1.1.5"&gt;1.1.5&lt;/a&gt; (2020-08-10)</h2>
<h2><a class="anchor" id="autotoc_md221"></a>
Bug Fixes</h2>
<ul>
<li><b>object-id:</b> harden the duck-typing (<a href="https://github.com/mongodb/js-bson/commit/b5261450c3bc4abb2e2fb19b5b1a7aba27982d44">b526145</a>)</li>
</ul>
<p><a class="anchor" id="1.1.3"></a> </p>
<h1><a class="anchor" id="autotoc_md222"></a>
&lt;a href="https://github.com/mongodb/js-bson/compare/v1.1.2...v1.1.3"&gt;1.1.3&lt;/a&gt; (2019-11-09)</h1>
<p>Reverts 1.1.2</p>
<p><a class="anchor" id="1.1.2"></a> </p>
<h1><a class="anchor" id="autotoc_md223"></a>
&lt;a href="https://github.com/mongodb/js-bson/compare/v1.1.1...v1.1.2"&gt;1.1.2&lt;/a&gt; (2019-11-08)</h1>
<h2><a class="anchor" id="autotoc_md224"></a>
Bug Fixes</h2>
<ul>
<li>**_bsontype:** only check bsontype if it is a prototype member. (<a href="https://github.com/mongodb/js-bson/commit/dd8a349">dd8a349</a>)</li>
</ul>
<p><a class="anchor" id="1.1.1"></a> </p>
<h1><a class="anchor" id="autotoc_md225"></a>
&lt;a href="https://github.com/mongodb/js-bson/compare/v1.1.0...v1.1.1"&gt;1.1.1&lt;/a&gt; (2019-03-08)</h1>
<h2><a class="anchor" id="autotoc_md226"></a>
Bug Fixes</h2>
<ul>
<li><b>object-id:</b> support 4.x-&gt;1.x interop for MinKey and ObjectId (<a href="https://github.com/mongodb/js-bson/commit/53419a5">53419a5</a>)</li>
</ul>
<h2><a class="anchor" id="autotoc_md227"></a>
Features</h2>
<ul>
<li>replace new Buffer with modern versions (<a href="https://github.com/mongodb/js-bson/commit/24aefba">24aefba</a>)</li>
</ul>
<p><a class="anchor" id="1.1.0"></a> </p>
<h1><a class="anchor" id="autotoc_md228"></a>
&lt;a href="https://github.com/mongodb/js-bson/compare/v1.0.9...v1.1.0"&gt;1.1.0&lt;/a&gt; (2018-08-13)</h1>
<h3><a class="anchor" id="autotoc_md229"></a>
Bug Fixes</h3>
<ul>
<li><b>serializer:</b> do not use checkKeys for $clusterTime (<a href="https://github.com/mongodb/js-bson/commit/573e141">573e141</a>)</li>
</ul>
<p><a class="anchor" id="1.0.9"></a> </p>
<h2><a class="anchor" id="autotoc_md230"></a>
&lt;a href="https://github.com/mongodb/js-bson/compare/v1.0.8...v1.0.9"&gt;1.0.9&lt;/a&gt; (2018-06-07)</h2>
<h3><a class="anchor" id="autotoc_md231"></a>
Bug Fixes</h3>
<ul>
<li><b>serializer:</b> remove use of <code>const</code> (<a href="https://github.com/mongodb/js-bson/commit/5feb12f">5feb12f</a>)</li>
</ul>
<p><a class="anchor" id="1.0.7"></a> </p>
<h2><a class="anchor" id="autotoc_md232"></a>
&lt;a href="https://github.com/mongodb/js-bson/compare/v1.0.6...v1.0.7"&gt;1.0.7&lt;/a&gt; (2018-06-06)</h2>
<h3><a class="anchor" id="autotoc_md233"></a>
Bug Fixes</h3>
<ul>
<li><b>binary:</b> add type checking for buffer (<a href="https://github.com/mongodb/js-bson/commit/26b05b5">26b05b5</a>)</li>
<li><b>bson:</b> fix custom inspect property (<a href="https://github.com/mongodb/js-bson/commit/080323b">080323b</a>)</li>
<li><b>readme:</b> clarify documentation about deserialize methods (<a href="https://github.com/mongodb/js-bson/commit/20f764c">20f764c</a>)</li>
<li><b>serialization:</b> normalize function stringification (<a href="https://github.com/mongodb/js-bson/commit/1320c10">1320c10</a>)</li>
</ul>
<p><a class="anchor" id="1.0.6"></a> </p>
<h2><a class="anchor" id="autotoc_md234"></a>
&lt;a href="https://github.com/mongodb/js-bson/compare/v1.0.5...v1.0.6"&gt;1.0.6&lt;/a&gt; (2018-03-12)</h2>
<h3><a class="anchor" id="autotoc_md235"></a>
Features</h3>
<ul>
<li><b>serialization:</b> support arbitrary sizes for the internal serialization buffer (<a href="https://github.com/mongodb/js-bson/commit/abe97bc">abe97bc</a>)</li>
</ul>
...
Bug Fixes</h3>
<ul>
<li><b>decimal128:</b> add basic guard against REDOS attacks (<a href="https://github.com/mongodb/js-bson/commit/bd61c45">bd61c45</a>)</li>
<li><b>objectid:</b> if pid is 1, use random value (<a href="https://github.com/mongodb/js-bson/commit/e188ae6">e188ae6</a>)</li>
</ul>
<h2><a class="anchor" id="autotoc_md238"></a>
1.0.4 2016-01-11</h2>
<ul>
<li>#204 remove Buffer.from as it's partially broken in early 4.x.x. series of node releases.</li>
</ul>
<h2><a class="anchor" id="autotoc_md239"></a>
1.0.3 2016-01-03</h2>
<ul>
<li>Fixed toString for ObjectId so it will work with inspect.</li>
</ul>
<h2><a class="anchor" id="autotoc_md240"></a>
1.0.2 2016-01-02</h2>
<ul>
<li>Minor optimizations for ObjectID to use Buffer.from where available.</li>
</ul>
<h2><a class="anchor" id="autotoc_md241"></a>
1.0.1 2016-12-06</h2>
<ul>
<li>Reverse behavior for undefined to be serialized as NULL. MongoDB 3.4 does not allow for undefined comparisons.</li>
</ul>
<h2><a class="anchor" id="autotoc_md242"></a>
1.0.0 2016-12-06</h2>
<ul>
<li>Introduced new BSON API and documentation.</li>
</ul>
...
0.5.6 2016-10-19</h2>
<ul>
<li>NODE-833, Detects cyclic dependencies in documents and throws error if one is found.</li>
<li>Fix(deserializer): corrected the check for (size + index) comparison… (Issue #195, <a href="https://github.com/JoelParke">https://github.com/JoelParke</a>).</li>
</ul>
...
0.5.4 2016-08-23</h2>
<ul>
<li>Added promoteValues flag (default to true) allowing user to specify if deserialization should be into wrapper classes only.</li>
</ul>
<h2><a class="anchor" id="autotoc_md247"></a>
0.5.3 2016-07-11</h2>
<ul>
<li>Throw error if ObjectId is not a string or a buffer.</li>
</ul>
...
0.4.22 2016-03-04</h2>
<ul>
<li>Fix "TypeError: data.copy is not a function" in Electron (Issue #170, <a href="https://github.com/kangas">https://github.com/kangas</a>).</li>
<li>Fixed issue with undefined type on deserializing.</li>
</ul>
<h2><a class="anchor" id="autotoc_md253"></a>
0.4.21 2016-01-12</h2>
<ul>
<li>Minor optimizations to avoid non needed object creation.</li>
</ul>
<h2><a class="anchor" id="autotoc_md254"></a>
0.4.20 2015-10-15</h2>
<ul>
<li>Added bower file to repository.</li>
<li>Fixed browser pid sometimes set greater than 0xFFFF on browsers (Issue #155, <a href="https://github.com/rahatarmanahmed">https://github.com/rahatarmanahmed</a>)</li>
</ul>
<h2><a class="anchor" id="autotoc_md255"></a>
0.4.19 2015-10-15</h2>
<ul>
<li>Remove all support for bson-ext.</li>
</ul>
<h2><a class="anchor" id="autotoc_md256"></a>
0.4.18 2015-10-15</h2>
<ul>
...
0.2.3 2013-10-01</h2>
<ul>
<li>Drying of ObjectId code for generation of id (Issue #54, <a href="https://github.com/moredip">https://github.com/moredip</a>)</li>
<li>Fixed issue where corrupt CString's could cause endless loop</li>
<li>Support for Node 0.11.X &gt; (Issue #49, <a href="https://github.com/kkoopa">https://github.com/kkoopa</a>)</li>
</ul>
