...
<div class="contents">
<div class="textblock"><p><a href="https://nodei.co/npm/mongodb/"><img src="https://nodei.co/npm/mongodb.png?downloads=true&amp;downloadRank=true" alt="npm" class="inline"/></a> <a href="https://nodei.co/npm/mongodb/"><img src="https://nodei.co/npm-dl/mongodb.png?months=6&amp;height=3" alt="npm" class="inline"/></a></p>
<p><a href="http://travis-ci.org/mongodb/node-mongodb-native"><img src="https://secure.travis-ci.org/mongodb/node-mongodb-native.svg?branch=2.1" alt="Build Status" style="pointer-events: none;" class="inline"/></a> <a href="https://coveralls.io/github/mongodb/node-mongodb-native?branch=2.1"><img src="https://coveralls.io/repos/github/mongodb/node-mongodb-native/badge.svg?branch=2.1" alt="Coverage Status" style="pointer-events: none;" class="inline"/></a> <a href="https://gitter.im/mongodb/node-mongodb-native?utm_source=badge&amp;utm_medium=badge&amp;utm_campaign=pr-badge"><img src="https://badges.gitter.im/Join%20Chat.svg" alt="Gitter" style="pointer-events: none;" class="inline"/></a></p>
...
<p><b>NOTE: v3.x was recently released with breaking API changes. You can find a list of changes here.</b></p>
<h2><a class="anchor" id="autotoc_md1846"></a>
MongoDB Node.JS Driver</h2>
...
<h3><a class="anchor" id="autotoc_md1849"></a>
Change Log</h3>
<p>Change history can be found in C:/Users/dylbu/OneDrive/Documents/School/Capstone <a class="el" href="mongodb_2_h_i_s_t_o_r_y_8md.html">Project/TeamParadise/API/node_modules/mongodb/HISTORY.md</a> "`HISTORY.md`".</p>
<h3><a class="anchor" id="autotoc_md1850"></a>
Compatibility</h3>
...
<div class="fragment"><div class="line">npm install mongodb --save</div>
...
<div class="fragment"><div class="line">git clone https://github.com/mongodb-js/kerberos</div>
<div class="line">cd kerberos</div>
<div class="line">npm install</div>
</div><!-- fragment --><p>If all the steps complete, you have the right toolchain installed. If you get the error "node-gyp not found," you need to install <code>node-gyp</code> globally:</p>
<div class="fragment"><div class="line">npm install -g node-gyp</div>
</div><!-- fragment --><p>If it correctly compiles and runs the tests you are golden. We can now try to install the <code>mongod</code> driver by performing the following command.</p>
<div class="fragment"><div class="line">cd yourproject</div>
<div class="line">npm install mongodb --save</div>
</div><!-- fragment --><p>If it still fails the next step is to examine the npm log. Rerun the command but in this case in verbose mode.</p>
<div class="fragment"><div class="line">npm --loglevel verbose install mongodb</div>
</div><!-- fragment --><p>This will print out all the steps npm is performing while trying to install the module.</p>
<h3><a class="anchor" id="autotoc_md1855"></a>
Diagnosing on Windows</h3>
...
<div class="fragment"><div class="line">npm install -g node-gyp</div>
</div><!-- fragment --><p>Next, you will have to build the project manually to test it. Clone the repo, install dependencies and rebuild:</p>
<div class="fragment"><div class="line">git clone https://github.com/christkv/kerberos.git</div>
<div class="line">cd kerberos</div>
<div class="line">npm install</div>
<div class="line">node-gyp rebuild</div>
</div><!-- fragment --><p>This should rebuild the driver successfully if you have everything set up correctly.</p>
<h3><a class="anchor" id="autotoc_md1856"></a>
Other possible issues</h3>
...
Create the &lt;tt&gt;package.json&lt;/tt&gt; file</h3>
...
</div><!-- fragment --><p>Next, install the driver dependency.</p>
<div class="fragment"><div class="line">npm install mongodb --save</div>
</div><!-- fragment --><p>You should see <b>NPM</b> download a lot of files. Once it's done you'll find all the downloaded packages under the <b>node_modules</b> directory.</p>
<h3><a class="anchor" id="autotoc_md1859"></a>
Start a MongoDB Server</h3>
...
<div class="fragment"><div class="line">const MongoClient = require(&#39;mongodb&#39;).MongoClient;</div>
<div class="line">const assert = require(&#39;assert&#39;);</div>
<div class="line"> </div>
...
<div class="line">MongoClient.connect(url, function(err, client) {</div>
<div class="line">  assert.equal(null, err);</div>
...
<div class="fragment"><div class="line">const insertDocuments = function(db, callback) {</div>
<div class="line">  // Get the documents collection</div>
<div class="line">  const collection = db.collection(&#39;documents&#39;);</div>
<div class="line">  // Insert some documents</div>
<div class="line">  collection.insertMany([</div>
<div class="line">    {a : 1}, {a : 2}, {a : 3}</div>
<div class="line">  ], function(err, result) {</div>
<div class="line">    assert.equal(err, null);</div>
<div class="line">    assert.equal(3, result.result.n);</div>
<div class="line">    assert.equal(3, result.ops.length);</div>
<div class="line">    console.log(&quot;Inserted 3 documents into the collection&quot;);</div>
<div class="line">    callback(result);</div>
<div class="line">  });</div>
<div class="line">}</div>
</div><!-- fragment --><p>The <b>insert</b> command returns an object with the following fields:</p>
<ul>
...
<div class="line">  const db = client.db(dbName);</div>
<div class="line"> </div>
<div class="line">  insertDocuments(db, function() {</div>
<div class="line">    client.close();</div>
<div class="line">  });</div>
<div class="line">});</div>
</div><!-- fragment --><p>Run the updated <b>app.js</b> file:</p>
<div class="fragment"><div class="line">node app.js</div>
</div><!-- fragment --><p>The operation returns the following output:</p>
<div class="fragment"><div class="line">Connected successfully to server</div>
<div class="line">Inserted 3 documents into the collection</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md1862"></a>
Find All Documents</h3>
<p>Add a query that returns all the documents.</p>
<div class="fragment"><div class="line">const findDocuments = function(db, callback) {</div>
<div class="line">  // Get the documents collection</div>
<div class="line">  const collection = db.collection(&#39;documents&#39;);</div>
<div class="line">  // Find some documents</div>
<div class="line">  collection.find({}).toArray(function(err, docs) {</div>
<div class="line">    assert.equal(err, null);</div>
<div class="line">    console.log(&quot;Found the following records&quot;);</div>
<div class="line">    console.log(docs)</div>
<div class="line">    callback(docs);</div>
<div class="line">  });</div>
<div class="line">}</div>
</div><!-- fragment --><p>This query returns all the documents in the <b>documents</b> collection. Add the <b>findDocument</b> method to the <b>MongoClient.connect</b> callback:</p>
<div class="fragment"><div class="line">const MongoClient = require(&#39;mongodb&#39;).MongoClient;</div>
<div class="line">const assert = require(&#39;assert&#39;);</div>
<div class="line"> </div>
<div class="line">// Connection URL</div>
...
<div class="line">MongoClient.connect(url, function(err, client) {</div>
<div class="line">  assert.equal(null, err);</div>
<div class="line">  console.log(&quot;Connected correctly to server&quot;);</div>
<div class="line"> </div>
<div class="line">  const db = client.db(dbName);</div>
<div class="line"> </div>
<div class="line">  insertDocuments(db, function() {</div>
<div class="line">    findDocuments(db, function() {</div>
<div class="line">      client.close();</div>
<div class="line">    });</div>
<div class="line">  });</div>
<div class="line">});</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md1863"></a>
Find Documents with a Query Filter</h3>
<p>Add a query filter to find only documents which meet the query criteria.</p>
<div class="fragment"><div class="line">const findDocuments = function(db, callback) {</div>
<div class="line">  // Get the documents collection</div>
<div class="line">  const collection = db.collection(&#39;documents&#39;);</div>
<div class="line">  // Find some documents</div>
<div class="line">  collection.find({&#39;a&#39;: 3}).toArray(function(err, docs) {</div>
<div class="line">    assert.equal(err, null);</div>
<div class="line">    console.log(&quot;Found the following records&quot;);</div>
<div class="line">    console.log(docs);</div>
<div class="line">    callback(docs);</div>
<div class="line">  });</div>
<div class="line">}</div>
</div><!-- fragment --><p>Only the documents which match <code>'a' : 3</code> should be returned.</p>
<h3><a class="anchor" id="autotoc_md1864"></a>
Update a document</h3>
<p>The following operation updates a document in the <b>documents</b> collection.</p>
<div class="fragment"><div class="line">const updateDocument = function(db, callback) {</div>
<div class="line">  // Get the documents collection</div>
<div class="line">  const collection = db.collection(&#39;documents&#39;);</div>
<div class="line">  // Update document where a is 2, set b equal to 1</div>
<div class="line">  collection.updateOne({ a : 2 }</div>
<div class="line">    , { $set: { b : 1 } }, function(err, result) {</div>
<div class="line">    assert.equal(err, null);</div>
<div class="line">    assert.equal(1, result.result.n);</div>
<div class="line">    console.log(&quot;Updated the document with the field a equal to 2&quot;);</div>
<div class="line">    callback(result);</div>
<div class="line">  });</div>
<div class="line">}</div>
</div><!-- fragment --><p>The method updates the first document where the field <b>a</b> is equal to <b>2</b> by adding a new field <b>b</b> to the document set to <b>1</b>. Next, update the callback function from <b>MongoClient.connect</b> to include the update method.</p>
<div class="fragment"><div class="line">const MongoClient = require(&#39;mongodb&#39;).MongoClient;</div>
<div class="line">const assert = require(&#39;assert&#39;);</div>
<div class="line"> </div>
<div class="line">// Connection URL</div>
...
<div class="line"> </div>
<div class="line">  insertDocuments(db, function() {</div>
<div class="line">    updateDocument(db, function() {</div>
<div class="line">      client.close();</div>
<div class="line">    });</div>
<div class="line">  });</div>
<div class="line">});</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md1865"></a>
Remove a document</h3>
<p>Remove the document where the field <b>a</b> is equal to <b>3</b>.</p>
<div class="fragment"><div class="line">const removeDocument = function(db, callback) {</div>
<div class="line">  // Get the documents collection</div>
<div class="line">  const collection = db.collection(&#39;documents&#39;);</div>
<div class="line">  // Delete document where a is 3</div>
<div class="line">  collection.deleteOne({ a : 3 }, function(err, result) {</div>
<div class="line">    assert.equal(err, null);</div>
<div class="line">    assert.equal(1, result.result.n);</div>
<div class="line">    console.log(&quot;Removed the document with the field a equal to 3&quot;);</div>
<div class="line">    callback(result);</div>
<div class="line">  });</div>
<div class="line">}</div>
</div><!-- fragment --><p>Add the new method to the <b>MongoClient.connect</b> callback function.</p>
<div class="fragment"><div class="line">const MongoClient = require(&#39;mongodb&#39;).MongoClient;</div>
<div class="line">const assert = require(&#39;assert&#39;);</div>
<div class="line"> </div>
<div class="line">// Connection URL</div>
...
<div class="line">  insertDocuments(db, function() {</div>
<div class="line">    updateDocument(db, function() {</div>
<div class="line">      removeDocument(db, function() {</div>
<div class="line">        client.close();</div>
<div class="line">      });</div>
<div class="line">    });</div>
<div class="line">  });</div>
<div class="line">});</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md1866"></a>
Index a Collection</h3>
...
<div class="fragment"><div class="line">const indexCollection = function(db, callback) {</div>
<div class="line">  db.collection(&#39;documents&#39;).createIndex(</div>
...
<div class="line">  );</div>
<div class="line">};</div>
</div><!-- fragment --><p>Add the <code>indexCollection</code> method to your app:</p>
<div class="fragment"><div class="line">const MongoClient = require(&#39;mongodb&#39;).MongoClient;</div>
<div class="line">const assert = require(&#39;assert&#39;);</div>
<div class="line"> </div>
<div class="line">// Connection URL</div>
...
<div class="line"> </div>
<div class="line">  insertDocuments(db, function() {</div>
<div class="line">    indexCollection(db, function() {</div>
<div class="line">      client.close();</div>
<div class="line">    });</div>
<div class="line">  });</div>
<div class="line">});</div>
</div><!-- fragment --><p>For more detailed information, see the tutorials.</p>
...
License</h2>
<p>C:/Users/dylbu/OneDrive/Documents/School/Capstone <a class="el" href="mongodb_2_l_i_c_e_n_s_e_8md.html">Project/TeamParadise/API/node_modules/mongodb/LICENSE.md</a> "Apache 2.0"</p>
